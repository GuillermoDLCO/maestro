...
if [ -z "$MAESTRO_VERSION" ]; then
    download_url="https://github.com/GuillermoDLCO/maestro/releases/latest/download/maestro.zip"
else
    download_url="https://github.com/GuillermoDLCO/maestro/releases/download/cli-$MAESTRO_VERSION/maestro.zip"
fi
